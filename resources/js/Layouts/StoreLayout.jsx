        ...
        <div className="font-sans antialiased bg-gray-50 text-gray-800 flex flex-col min-h-screen">
                    ...
                    <div className="flex justify-between h-16">
                        <div className="flex items-center">
                            ...
                            <div className="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex h-full">
                                <Link
                                    href="/store"
                                    className="inline-flex items-center px-1 pt-1 border-b-2 border-[#FF6900] text-sm font-medium leading-5 text-gray-900 focus:outline-none transition duration-150 ease-in-out"
                                >
                                    Mobiles
                                </Link>
                            </div>
                        ...
                        <div className="flex items-center gap-6">
                            <Link
                                href="/cart"
                                className="relative text-gray-600 hover:text-[#FF6900] transition"
                            >
                                <svg
                                    className="w-6 h-6"
                                    fill="none"
                            ...
                            {auth.user ? (
                                <>
                                    ...
                                    <div className="relative">
                                        <button
                                            ...
                                            className="flex items-center gap-2 text-sm text-gray-700 font-medium hover:text-[#FF6900] focus:outline-none transition"
                                        >
                                            {auth.user.name}
                                            <svg
                                        ...
                                        {open && (
                                            <div className="absolute right-0 mt-3 w-48 bg-white border border-gray-100 rounded-xl shadow-xl z-50 overflow-hidden transition-all">
                                                ...
                                                <Link
                                                    href="/my-orders"
                                                    className="block px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 hover:text-[#FF6900] transition border-t border-gray-50"
                                                >
                                                    Pesanan Saya
                                                </Link>
                                ...
                                <>
                                    <Link
                                        href="/login"
                                        className="text-sm text-gray-700 font-medium hover:text-[#FF6900]"
                                    >
                                        Masuk
                                    </Link>
                                    <Link
            ...
            <footer className="bg-white border-t border-gray-200 mt-auto py-8">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-sm text-gray-500">
                    &copy; {new Date().getFullYear()} Tugas Akhir PWF. All
                    rights reserved.
                </div>
            </footer>
        </div>
